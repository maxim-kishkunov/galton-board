...
class UsersTable extends Component {
    ...
    getTableData(){        
        axios.get(`http://ktpsys.ddns.net:84/get_lect_data`).then(response => {
    ...
    handleChangeUserGroup(key, option){
        ...
        axios.post(`http://ktpsys.ddns.net:84/change_user_group`, params).then(response => {
            this.getTableData();
        }).catch(error => {
            console.error(error);
        })
    ...
    deleteUser(user_id){
        axios.post(`http://ktpsys.ddns.net:84/delete_user`, {
            user_id: user_id,
        }).then(response => {
            this.getTableData();
        }).catch(error => {
    ...
    createNewGroup() {
        ...
        axios.post(`http://ktpsys.ddns.net:84/create_new_group`, params)
        .then(response => {
            this.getTableData();
        }).catch(error => {
            console.error(error);
    ...
    handleSubmit(group_id) {        
        ...
        axios.post(`http://ktpsys.ddns.net:84/create_group_input`, params)
        .then(response => {
            this.getTableData();
        }).catch(error => {
            console.error(error);
